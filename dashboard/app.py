...
from data.loader import load_raw_data, VAGUE_LABELS, CITIES
...
with st.sidebar:
    ...
    if selected_vagues:
        filtered_count = len(data[data["Vague"].isin(selected_vagues)])
...
if module == "Brand Health Tracker":
    from views import tracker_overview, tracker_notoriete, tracker_usage, tracker_image, tracker_satisfaction, tracker_geo
